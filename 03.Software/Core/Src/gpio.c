...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, DHT11_D_Pin|DCDC_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, ESP_EN_Pin|RUNLED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ESP_EN_Pin RUNLED_Pin */
  GPIO_InitStruct.Pin = ESP_EN_Pin|RUNLED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
